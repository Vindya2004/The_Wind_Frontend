    ...
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            <p className='text-gray-500 mb-4'>
                Be the first to hear about new products,exclusive evens and online offers.
            </p>
        ...
        <div>
            ...
            <ul className='space-y-2 text-gray-600'>
                <li>
                    <Link to="#" className='hover:text-gray-500 transition-colors'>Men's Shooes
                    </Link>
                </li>
                 <li>
                    <Link to="#" className='hover:text-gray-500 transition-colors'>Women's Shooes
                    </Link>
                </li>
                 <li>
                    <Link to="#" className='hover:text-gray-500 transition-colors'>Men's Sandals
                    </Link>
                </li>
                 <li>
                    <Link to="#" className='hover:text-gray-500 transition-colors'>Women's Sandals
                    </Link>
                </li>
            </ul>
        </div>
