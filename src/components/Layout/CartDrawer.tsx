...
//   return (
//     <div 
//     className={`fixed top-0 right-0 w-3/4 sm:w-[30rem] h-full bg-white shadow-lg transform
...
//                 {cart && cart?.products?.length > 0 ? (<CartContent cart={cart} userId={userId guestId=
//                     {guestId}}/>): (
...
const CartDrawer: React.FC<CartDrawerProps> = ({
  ...
  return (
    <div
      className={`fixed top-0 right-0 w-3/4 sm:w-[30rem] h-full bg-white shadow-lg
