           ...
           <h2 className='text-lg font-semibold text-gray-700 mb-2'>
            ...
            <p className='text-lg text-gray-600 mb-6'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur,
                 ullam alias rerum explicabo neque reprehenderit tenetur magni optio 
                 nesciunt labore sint quaerat sunt, veritatis est vero, asperiores ad consequuntur excepturi!
            </p>
