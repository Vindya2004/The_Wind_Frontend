...
const selectedProduct = {
    ...
    price: 120,
    originalPrice: 150,
    description: "This is a stylish heels perfect for any accation",
    brand: "KlearMarry",
    meterial: "Leather",
    sizes: ["6","7","9","12"],
    colors: ["Red","Black"],
    images: [
        {
            ...
            altText: "Stylish Heel 1",
        },
        {
            url: "https://picsum.photos/500/500?random=2",
            altText: "Stylish Heel 2",
        },
    ]
}
            ...
            <div className='flex flex-col md:flex-row'>
                ...
                <div className='md:w-1/2 md:ml-10'>
                 ...
                 <button 
                    ...
                    className={`bg-black text-white py-2 px-6 rounded w-full mb-4 ${isButtonDisable 
                    ...
                    <table className='w-full text-left text-sm text-gray-600'>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td className='py-1'>{selectedProduct.meterial}</td>
                            </tr>
                        </tbody>
                    </table>
                 </div>
